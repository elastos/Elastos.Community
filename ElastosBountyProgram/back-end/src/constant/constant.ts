...
export const USER_SKILLSET = {
    ...SKILLSET_TYPE,
    ...create(['UX_DESIGN', 'UI_DESIGN', 'PRINT_DESIGN', 'MANUAL_TESTING', 'AUTOMATED_TESTING', 'DEVOPS',
        'OFFLINE_MARKETING', 'ONLINE_MARKETING', 'SEO', 'EVENT_ORGANIZE', 'LOGISTICS', 'TRANSLATION',
        'PROJECT_MANAGEMENT', 'PRODUCT_MANAGEMENT', 'HR', 'SALES' ])
}
