...
const zh = {
    ...
    'developer.learn.resources': '教程，资源及更多',
    'developer.team': '团队',
    ...
    'developer.cr100.welcome':'CR100是Cyber Republic的重要基础项目，由100个不同的项目组成，展示了Elastos生态系统的一些功能。 它们包括但不限于基础架构，DApp和实用程序解决方案。',
    ...
    'training.itinerary.content.day14Label': '第一天到第四天',
    'training.itinerary.content.day14': '学习亦来云的愿景和技术',
    ...
    'emp35.empower.content.1':'Empower35 将挑选 Cyber Republic 未来管理者和议员。他们在商业、市场营销、写作、视觉艺术、设计、法律和公众演讲方面的领域是专家，他们将塑造和促进 Cyber Republic 的未来发展',
    'emp35.empower.content.2':'在未来几周内，我们将开始接受每个职位的申请，Cyber Republic Council 将选择职位。被选中的合格申请者将获得 ELA 报酬，并可以根据他们的提议申请预算，管理和雇佣各自领域的团队',
    'emp35.empower.content.3':'这35个专家将建立和发展亦来云生态系统，在继续扩大 Cyber Republic 的同时，负责寻找下一组继任者',
