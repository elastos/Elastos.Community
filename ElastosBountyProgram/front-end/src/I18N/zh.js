...
const zh = {
    ...
    'community.selectcountry': '选择一个国家',
    'community.guidecontainer.part1': '您好！ 看起来我们还没有一个组织者',
    'community.guidecontainer.part2': '我们始终寻找新的组织者，特别是在新的社区',
    'community.guidecontainer.part3': "如果您想成为您所在区域的组织者请注册，我们将会添加您的国家，您就可以申请成为该页面的组织者。",
    ...
    'vision.03': '事实上, 陈榕和Elastos基金会已经无私地将项目方向的重任和权力交给了国际社区。同时Cyber Republic是Elastos的一部分，但这个项目的未来发展和经济模式将由Cyber Republic的成员自行组织，而不是Elastos基金会。Cyber Republic将在许多方面完全独立于基金会，并控制自己的发展。这一愿景需要时间才能实现。',
    ...
    'profile.detail.upload.comment': '用下面的评论功能与项目拥有者对话，并查找更多信息。',
