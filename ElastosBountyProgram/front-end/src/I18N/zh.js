...
const zh = {
    ...
    'landing.businessModel.content.5': '为大型区块链应用程序提供',
    'landing.businessModel.content.6': '安全的运行环境。为大数据和数字',
    'landing.businessModel.content.7': '内容在区块链上确认所有权。',
    'landing.businessModel.content.8': '',
    'landing.businessModel.content.9': '通过在区块链上令牌',
    'landing.businessModel.content.10': '的交换产生财富。',
    'landing.businessModel.content.11': '使用ELA令牌注册IDs来',
    'landing.businessModel.content.12': '购买DApps、数字产品',
    'landing.businessModel.content.13': '和云存储。',
    'landing.businessModel.content.14': '',
    'landing.businessModel.content.15': '通过限制数字资产',
    'landing.businessModel.content.16': '的固定数量创造稀缺性。',
    'landing.businessModel.content.17': '',
    'landing.businessModel.content.18': '赋予大型区块链应用程序',
    'landing.businessModel.content.19': '能够运行在设备上而不是',
    'landing.businessModel.content.20': '在区块链节点上的能力。',
    'landing.businessModel.content.21': '',
    'landing.businessModel.content.22': '提供一个安全的运行环境，',
    'landing.businessModel.content.23': '免除中间环节，避免分布',
    'landing.businessModel.content.24': '式拒绝服务攻击和其他',
    'landing.businessModel.content.25': '网络攻击。',
    'landing.businessModel.content.26': '',
    'landing.businessModel.content.27': '通过集成SDK，轻松将',
    'landing.businessModel.content.28': '现有的移动应用程序',
    'landing.businessModel.content.29': '移植到Elastos平台上。',
    'landing.businessModel.content.30': '',
