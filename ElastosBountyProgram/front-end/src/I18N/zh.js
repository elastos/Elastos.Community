...
const zh = {
    ...
    'circle.uploadhint': '用下面的评论功能与项目拥有者对话，并查找更多信息。',
    ...
    'project.detail.recruiting_skills_unknown': '未指定',
    ...
    'project.detail.columns.action': '操作',
    ...
    'landing.whatIs.content.1': 'Elastos是第一个完全安全和去中心化的互联网环境。使用区块链构建，它提供了一个虚拟生态系统，来保护去中心化式应用程序不受互联网的直接访问，同时为数十亿用户提供近乎无限的可扩展性。',
    'landing.whatIs.content.2': 'Elastos是一个“Cyber Republic”，其通过对数据和数字资产的确权和交换来产生财富。',
    ...
    'landing.usecase.content.2': '通信支持点对点对话,',
    ...
    // Our Vision
    'vision.00': '我们的愿景',
    'vision.01': 'Cyber Republic的愿景开始于一个雄心勃勃的想法: 创建一个自主运营、自治的企业家和开发人员社区，它们可以独立于亦来云发挥作用，但有统一的目标是把它发展成全球性的成功。',
    'vision.02': '新网站刚刚推出Alpha版本。发现任务并获取ELA的基本功能仍然保留。但是新增的CR100和Empower35项目仍处于早期阶段,它们不仅代表我们长期成功的愿景,更需要社区和Cyber Republic 未来的领导者来协助编制和塑造这些项目的工作机制、流程及社区生态经济。',
    'vision.03': '事实上, 陈榕和亦来云基金会已经无私地将项目方向的重任和权力交给了国际社区。虽然Cyber Republic是亦来云的一部分，但她的未来发展和经济模式将由Cyber Republic的成员自行组织管理，而不是亦来云基金会。Cyber Republic将在许多方面完全独立于基金会，并控制自己的发展。这一愿景需要时间才能实现。',
    ...
    'profile.detail.form.bid.required': '您必须投标',
