...
const zh = {
    ...
    'profile.detail.tobeorganizer': '你是否想成为组织者？',
    'profile.detail.tobeengineer': '你是软件开发者或工程师吗？',
    ...
    'from.CVoteForm.proposal.content': 'Cyber Republic共治委员会委员可以使用这个表格提交动议。Cyber Republic的所有公民都可以查阅并在线下分享他们自己的想法。所有的提议都会理事会例会上进行讨论。所有结果将会公开披露。这是Cyber Republic的网站有这个功能前的暂行方案。',
    ...
    'from.OrganizerAppForm.education.required': '请填写教育程度',
    ...
    'from.OrganizerAppForm.language': '你的母语是什么，谁是您的听众和他们所在的地区在哪里?你会使用哪（几）种语言去介绍亦来云。',
    'from.OrganizerAppForm.speaking': '请描述你的公开演讲的经验并提供相关例子。',
    'from.OrganizerAppForm.organizer': '你曾有过组织活动的经验吗？请提供相关例子。',
    ...
    'from.Training1Form.text.nativelanguage': '你的母语是什么，谁是受众和他们所在的地方在哪里?您会使用哪种语言来介绍亦来云。',
    ...
    'from.Training1Form.text.tellfeword': '请简单说明是什么启发您参加 Cyber Republic。',
    'from.Training1Form.text.submitvideo': '请提交视频描述亦来云对您的意义。',
    ...
    'from.UserContactForm.text.emailreply': "电子邮件回复地址将设置为您帐户的电子邮件，回复将直接发送到您的电子邮箱",
    ...
    'cr-video.q4.paragraph.5': '贡献者可以做任何事情，从检查bug到企业级DApp开发，从撰写博客到组织国际会议。您参与建设Cyber Republic是没有任何条条框框的，可以自由地制定和执行您的好主意。无论您的视野和专业知识包含什么，都将受到社区的欢迎。',
    'cr-video.q5': '为何要加入Cyber Republic？',
    'cr-video.q5.paragraph.1': '为何不呢？如果您正在阅读这篇文章，也许你已经觉得需要一些目前的互联网无法提供的东西。那么谁是能够塑造你愿景里的新型互联网的最佳选择呢？相信您已经知道答案了。所以请加入我们，注册、连接然后改变世界。 您就能成为一个新型智能互联网的联合创始人。',
    'cr-video.q6': '如何加入Cyber Republic',
    'cr-video.q6.title.1': '第一步：在Cyber Republic平台上注册',
    'cr-video.q6.paragraph.1': '您能做到',
    'cr-video.q6.title.1_2': '第一步：注册。看起来您已经注册了，那么您完成接下来的步骤了吗？',
    ...
    'cr-video.q6.title.5': '第五步：作为新型互联网的联合创始人，剩下的就交给您自己决定。',
