...
const zh = {
    ...
    'landing.businessModel.content.6': '提供安全的运行环境。',
    'landing.businessModel.content.7': '为大数据和数字内容',
    'landing.businessModel.content.8': '在区块链上确认所有权',
    'landing.businessModel.content.9': '通过在区块链上令牌',
    'landing.businessModel.content.10': '的交换产生财富。',
    'landing.businessModel.content.11': '',
    'landing.businessModel.content.12': '',
    'landing.businessModel.content.13': '',
    'landing.businessModel.content.14': '使用ELA令牌注册IDs来',
    'landing.businessModel.content.15': '购买DApps、数字产品',
    'landing.businessModel.content.16': '和云存储。',
    'landing.businessModel.content.17': '',
    'landing.businessModel.content.18': '通过限制数字资产',
    'landing.businessModel.content.19': '的固定数量创造稀缺性。',
