...
const en = {
    ...
    // Module form
    'from.AnniversaryEventForm.readrules.required': 'You must agree to the rules and requirements',
    'from.AnniversaryEventForm.fullLegalName.required': 'Please input an name',
    'from.AnniversaryEventForm.fullLegalName.min': 'Name too short',
    'from.AnniversaryEventForm.walletAddress.required': 'Please input a wallet address',
    'from.AnniversaryEventForm.walletAddress.len': 'Address length error',
    'from.AnniversaryEventForm.upload': ' Upload Flight Receipt',
    'from.AnniversaryEventForm.upload.photoofpassport': 'Upload Photo of Passport',
    ...
    'from.OrganizerAppForm.audienceInfo.required': 'This is a required field',
    ...
    'from.OrganizerAppForm.audienceInfo.max': 'Text too long',
    ...
    'from.TaskCreateForm.upload': 'Upload',
