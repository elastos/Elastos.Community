...
class C extends BaseComponent {
    ...
    getInputProps () {
        ...
        const audienceInfo_fn = getFieldDecorator('audienceInfo', {
            rules: [
                {required: true, message: I18N.get('from.OrganizerAppForm.audienceInfo.required')},
                {max: 256, message: I18N.get('from.OrganizerAppForm.audienceInfo.max')}
            ]
        })
        ...
        const publicSpeakingExp_fn = getFieldDecorator('publicSpeakingExp', {
            rules: [
                {required: true, message: I18N.get('from.OrganizerAppForm.audienceInfo.required')},
                {max: 1024, message: I18N.get('from.OrganizerAppForm.audienceInfo.max')}
            ]
        })
        ...
        const description_fn = getFieldDecorator('description', {
            rules: [
                {required: true, message: I18N.get('from.OrganizerAppForm.audienceInfo.required')},
                {max: 512, message: I18N.get('from.OrganizerAppForm.audienceInfo.max')}
            ]
        })
