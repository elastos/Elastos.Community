        ...
        return <div>
            ...
            <Row>
                <Col>
                    ...
                    <p>
                        ...
                        we'll also invite you to the Cyber Republic Slack channel.<br/>
                    </p>
                </Col>
            </Row>
            <br/>
            ...
            <Row>
                <Col>
                    ...
                    <iframe width="400" height="275" src="https://www.youtube.com/embed/AXtElROGXzA" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>

                    <h5>General Task Tutorial</h5>
                    <iframe width="400" height="275" src="https://www.youtube.com/embed/-90B2qzwOc8" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
                </Col>
            </Row>
        </div>
    }
        ...
        return <div>
            ...
            <Row>
                <Col>
                    ...
                    <p>
                        Elastos has many open source projects to learn from on Github and the documentation is also located there<br/>
                        <br/>
            ...
            <Row>
                <Col>
                    ...
                    <p>
                        We're always here to help, in Slack there are developer specific channels you can come to ask questions.<br/>
                        <br/>
                        There is no need to try to learn Elastos yourself, drop by Slack and share your ideas or ask us how to get started.
                    </p>

                    <p>
                        Still missing access to Slack? If you have registered your email on Cyber Republic,<br/>
                        send us an email at <a href="mailto:slack@elastos.org">slack@elastos.org</a> and we will send an invite.
                    </p>
                </Col>
            </Row>
        </div>
        ...
        return <div>
            ...
            <Row>
                <Col>
                    ...
                    <p>
                        ...
                        or just being active in the community.<br/>
                        <br/>
            ...
            <Row>
                <Col span={12} style={{paddingRight: '12px'}}>
                    ...
                    <p>
                        We are always looking for organizers, especially in countries or communities that do not have one yet.<br/>
                        <br/>
                        To see the current list of communities go to <a href="/community">the community page</a>, even if there are organizers for your community
                        ...
                        would like to represent, let us know at <a href="mailto:cyberrepublic@elastos.org">cyberrepublic@elastos.org</a>.
                    </p>
        ...
        return <div>
            ...
            <Row>
                <Col className="center">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/AXtElROGXzA" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
                </Col>
            </Row>
            ...
            <Row>
                <Col span={12} style={{paddingRight: '12px'}}>
                    ...
                    <p>
                        To become an organizer you must apply using the form found under each country in the <a href="/community">Community page</a>.
                        <br/>
                        <br/>
            ...
            <Row>
                <Col span={16} style={{paddingRight: '12px'}}>
                    ...
                    <p>
                        ...
                        you can create tasks by going to your profile and clicking Tasks in the menu.<br/>
                        <br/>
                        If you are an organizer you will see the <span style={{fontWeight: 600}}>Create Task</span> button in the top right.
                    </p>
                </Col>
                <Col span={8}>
        ...
        return <div>
            ...
            <Row>
                <Col span={16}>
                    ...
                    <p>
                        You can directly contact other members by clicking their username in the community and sending them an email through Cyber Republic.<br/>
                        <br/>
                    ...
                    <p>
                        We encourage you to rather chat with your fellow community members in the corresponding channels in Slack setup for your community.<br/>
                        <br/>
