        ...
        return (
            <div className="p_Privacy">
                ...
                <div className="ebp-page">
                    <Row className="d_row">
                        <p>
                            Elastos Foundation Ltd. (“Elastos”) on behalf of Cyber Republic deeply respects your concerns for privacy, and understands that crypto-currency and its community is built
                            around security and privacy. Therefore, this privacy policy (“Privacy Policy”) describes the type of information we collect, how we use this information and whom we share it.
                            Based on the community services we provide and in accordance with the EU General Data Protection Regulation (“GDPR”), we are both a data processor and a data collector.
                            ...
                            If at any point you have any questions regarding this Privacy Policy please contact us via email at the address listed in Section 10. Contact Information.
                        </p>

                        <h3>1. PURPOSE, USE AND PROCESSING OF YOUR PERSONAL INFORMATION.</h3>

                        <p>
                            The vision for Cyber Republic starts with an ambitious idea: create a self-running and self-governed community of entrepreneurs and developers who can function independently of Elastos but with the unified goal to grow it into a global success. With that vision in mind, Cyber Republic may use your personal information to find the right entrepreneurs and developers for certain tasks and projects.
                        </p>
                        <p>
                            In addition to our main vision statement, we may use your personal information, sometimes combined with non-personal information, in the following ways:
                        </p>

                        <ul>
                            <li>To identify you when you visit our website.</li>
                            <li>To provide the products, information, and services you request.</li>
                            <li>To improve and personalize your experience with us, including creating certain tasks specifically based on your experience and knowledge on a certain subject matter.</li>
                            <li>To conduct analytics and solve problems.</li>
                            <li>To respond to your inquiries related to support, tasks, projects, employment, or other requests.</li>
                        ...
                        <table className="typesOfData">
                            ...
                            <tr>
                                <td>
                                    Experience, Skill Sets and Languages
                                </td>
                                <td>
                                    You may provide and have us collect personal information regarding your experience and employment for certain subject matter knowledge, skill sets and spoken languages for CRcles, CR100, and other community involvement applications.
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <ul>
                            ...
                            <li><b>Other Disclosures without Your Consent.</b> We may disclose personal information in response to subpoenas, warrants, or court orders, in connection with any legal or regulatory process, or to comply with relevant laws.  We may also share your personal information in order to establish or exercise our rights, to defend against a legal claim, to investigate, prevent, or take action associated with possible illegal activities, suspected fraud, safety of person or property, for audit purposes, or a violation of our policies.</li>
                            ...
                            <li><b>Advertising and Marketing.</b> We may use any statements that you communicate to us through the website regarding Cyber Republic or Elastos or any of our products and services for advertising or marketing purposes.</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><b>Access to Your Personal information.</b> If required by law, upon request, we will grant reasonable access to personal information that we hold about you. Please direct all requests using the instructions described in Section 10. Contact Information.</li>
                            ...
                            <li><b>California Residents.</b> California residents under California Civil Code Section 1798.83 may be entitled to ask us for a notice describing what categories of personal information (if any) we share with third parties or affiliates for those parties to use for direct marketing. To submit your request, please email the address in the Contact Information section below with the subject line "California Privacy" and your request in the body of your email.</li>
                            ...
                            <li><b>Complaints.</b> Complaints can be sent to us by way of email or letter using the instructions listed in Section 10. Contact Information. Some jurisdictions may also allow you to complain to a data protection authority as well.</li>
                            <li><b>Rights under GDPR.</b> In addition to the above, you may also exercise your rights under GDPR as stated in Section 5. European & GDPR Privacy Rights.</li>
                        </ul>

                        <h3>5. European & GDPR Privacy Rights</h3>

                        <p>
                            Under GDPR, in certain circumstances, you have the right to: (a) request access to any personal information we hold about you and related information, (b) obtain without undue delay the rectification of any inaccurate personal information, (c) request that your personal information is deleted or erased provided the personal information is not required by us for compliance with a legal obligation under European or Member State law or for the establishment, exercise or defense of a legal claim, (d) prevent or restrict processing of your personal information, except to the extent processing is required for the establishment, exercise or defense of legal claims; (e) object to the processing of your personal data, and (e) request transfer of your personal information directly to a third-party where this is technically feasible.
                        </p>
                        <p>
                            You also have the right to complain to the ICO (www.ico.org.uk) if you feel there is a problem with the way we are handling your data.
                        </p>
                        <p>
                            We handle subject access requests in accordance with GDPR. Further you may learn more about your rights by visiting www.ico.org.uk.
                        </p>
                        <p>
                            You can exercise any of these rights by contacting us using the instructions described in Section 10. Contact Information.
                        </p>

                        <h3>6. WHAT ARE THE LEGAL GROUNDS FOR OUR PROCESSING OF YOUR PERSONAL INFORMATION (INCLUDING WHEN WE SHARE IT WITH OTHERS)?</h3>

                        <p>We rely on the following legal bases to use your personal data: (1) Consent, (2) Legal Obligation, or (3) Legitimate Interests.</p>

                        <p>
                            <b>Lawful basis:</b> Consent<br/>
                            <b>The reason we use this basis:</b> With your consent, we process information to provide you with the best possible Cyber Republic experience. We may process information in accordance with Section 1. Purpose, Use and Processing of Your Personal Information. Types of Information we collect may vary as explained in Section 2. Types of Information We Collect. You can withdraw your consent at any time by contacting us in writing using the Contact Information below.<br/>
                            <b>Data retention period:</b> We will continue to process your information under this basis until you withdraw consent or it is determined your consent no longer exists.<br/>
                            <b>Sharing your information:</b> We do not share your information with third parties.<br/>
                        </p>

                        <p>
                            <b>Lawful basis:</b> Legal obligation<br/>
                            <b>The reason we use this basis:</b> Cyber Republic may rely on this lawful basis if we need to process your personal data to comply with a common law or statutory obligation.<br/>
                            <b>Data retention period:</b> In accordance with local legislation and statutory obligation.<br/>
                            <b>Sharing your information:</b> We do not share your information with third parties.<br/>
                        </p>

                        <p>
                            <b>Lawful basis:</b> Legitimate interests<br/>
                            <b>The reason we use this basis:</b> We may process your information to provide you with the best Cyber Republic experience. This includes but is not limited to, (a) fraud detection and prevention (crime prevention), (b) compliance with foreign law, law enforcement, court and regulatory bodies’ requirements, (c) industry watch-lists and industry self-regulatory schemes, (d) information, system, network and cyber security, (e) general corporate operations and due diligence, (f) website development and enhancement, and (g) communications, marketing and intelligence.<br/>
                            <b>Data retention period:</b> We will continue to process your information under this basis until you withdraw consent or until it is determined that a legitimate interest no longer exists.<br/>
                            <b>Sharing your information:</b> We do not share your information with third parties.<br/>
                        </p>
                        ...
                        <p>
                            Elastos may use other web devices to track website usage and views. Please address any questions or concerns about our cookie or web device usage using the instructions described in Section 10. Contact Information.
                        </p>
                        ...
                        <p>If you have any questions, comments, or complaints concerning our privacy practices please contact us at the appropriate address below. We will respond to your requests in accordance with this Privacy Policy and in a reasonable time and manner. Please note that Elastos may elect not to respond to unreasonable or irrelevant requests.</p>
                        ...
                        <p>
                            Thank you from all of us for being part of the Elastos and Cyber Republic community.
                        </p>
                    </Row>
                </div>
                <Footer/>
